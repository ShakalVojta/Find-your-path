...
import { END_TILE_STYLE, MAX_ROWS, PATH_TILE_STYLE, START_TILE_STYLE, TILE_STYLE, TRAVERSED_TITLE_STYLE, WALL_TILE_STYLE } from "../utils/constants";
...
export function Tile ({
    ...
    if(isStart) {
        ...
        tileTypeStyle = TRAVERSED_TITLE_STYLE;
    } else {
